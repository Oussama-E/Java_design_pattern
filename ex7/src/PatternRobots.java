public class PatternRobots {
	...
	public static void main(String[] args) {
		...
		Robot robot1= // new SimpleRobot.Builder("Rob").canonPower(10).shieldPower(2).build();
				new DoubledCanon(new SimpleRobot.Builder("Rob").canonPower(10).shieldPower(2).build());
		...
		Robot robot2= //new SimpleRobot.Builder("Bot").canonPower(9).shieldPower(3).shootFrequency(90).build()
				new DoubledShield(new SimpleRobot.Builder("Bot").canonPower(9).shieldPower(3).shootFrequency(90).build());
		fight(robot1, robot2);
	}
